...
$(document).ready(function(){
	$("#current_pwd").keyup(function(){
		...
		$.ajax({
			...
			success:function(resp){
				...
				/*This is the reason why I get errror alert 
				everytime I type in current password input box*/
			}
		});
	});
	...
	// Coupons Form Validation
    $("#couponsForm_validation").validate({
		rules:{
			coupon_title:{
				required:true
			},
    ...
    // Banners Form Validation
    $("#bannersForm_validation").validate({
		rules:{
			banner_title:{
				required:true
			},
